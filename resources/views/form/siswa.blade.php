<div class="space-y-6">
    <div class="flex flex-col md:flex-row gap-6">
        <div class="w-full md:w-1/2">
            ...
            <x-text-input id="nama_lengkap" name="nama_lengkap" type="text" class="mt-1 block w-full" :value="old('nama_lengkap')"
        ...
        <div class="w-full md:w-1/2">
            ...
            <x-text-input id="nik" name="nik" type="text" class="mt-1 block w-full" :value="old('nik')"
                autocomplete="nik" />
    ...
    <div class="flex flex-col md:flex-row gap-6">
        <div class="w-full md:w-1/2">
            ...
            <x-text-input id="anak_ke" name="anak_ke" type="number" class="mt-1 block w-full" :value="old('anak_ke')"
    ...
    <div class="flex flex-col md:flex-row gap-6">
        <div class="w-full md:w-1/2">
            ...
            <x-select id="status_anak_dalam_keluarga" name="status_anak_dalam_keluarga" class="mt-1 block w-full">
    ...
    <div class="flex flex-col md:flex-row gap-6">
        <div class="w-full md:w-1/2">
            ...
            <x-text-input id="hobi" name="hobi" type="text" class="mt-1 block w-full" :value="old('hobi')"
                autocomplete="hobi" />
        ...
        <div class="w-full md:w-1/2">
            ...
            <x-text-input id="cita_cita" name="cita_cita" type="text" class="mt-1 block w-full" :value="old('cita_cita')"
                autocomplete="cita_cita" />
    ...
    <div class="flex flex-col md:flex-row gap-6">
        <div class="w-full md:w-1/2">
            ...
            <x-text-input id="jarak_ke_sekolah" name="jarak_ke_sekolah" type="text" class="mt-1 block w-full"
                :value="old('jarak_ke_sekolah')" autocomplete="jarak_ke_sekolah" />
        ...
        <div class="w-full md:w-1/2">
            ...
            <x-text-input id="transportasi_ke_sekolah" name="transportasi_ke_sekolah" type="text"
                class="mt-1 block w-full" :value="old('transportasi_ke_sekolah')" autocomplete="transportasi_ke_sekolah" />
    ...
    <div class="flex flex-col md:flex-row gap-6">
        <div class="w-full md:w-1/2">
            ...
            <x-text-input id="jalan" name="jalan" type="text" class="mt-1 block w-full" :value="old('jalan')"
                autocomplete="jalan" />
        ...
        <div class="w-full md:w-1/2">
            ...
            <x-text-input id="desa" name="desa" type="text" class="mt-1 block w-full" :value="old('desa')"
                autocomplete="desa" />
    ...
    <div class="flex flex-col md:flex-row gap-6">
        ...
        <div class="w-full md:w-1/2">
            ...
            <x-text-input id="kab_kota" name="kab_kota" type="text" class="mt-1 block w-full" :value="old('kab_kota')"
    ...
    <div class="flex flex-col md:flex-row gap-6">
        <div class="w-full md:w-1/2">
            ...
            <x-text-input id="pekerjaan_ayah" name="pekerjaan_ayah" type="text" class="mt-1 block w-full"
                :value="old('pekerjaan_ayah')" autocomplete="pekerjaan_ayah" />
    ...
    <div class="flex flex-col md:flex-row gap-6">
        <div class="w-full md:w-1/2">
            ...
            <x-text-input id="nama_ibu" name="nama_ibu" type="text" class="mt-1 block w-full" :value="old('nama_ibu')"
    ...
    <div class="flex flex-col md:flex-row gap-6">
        <div class="w-full md:w-1/2">
            ...
            <x-text-input id="pekerjaan_ibu" name="pekerjaan_ibu" type="text" class="mt-1 block w-full"
                :value="old('pekerjaan_ibu')" autocomplete="pekerjaan_ibu" />
    ...
    <div class="flex flex-col md:flex-row gap-6">
        <div class="w-full md:w-1/2">
            ...
            <x-text-input id="pekerjaan_wali" name="pekerjaan_wali" type="text" class="mt-1 block w-full"
                :value="old('pekerjaan_wali')" autocomplete="pekerjaan_wali" />
