        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                @can('admin')
                    ...
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        <x-nav-link :href="route('kategori-nilai.index')" :active="request()->routeIs('kategori-nilai*')">
                            {{ __('Kategori Nilai') }}
                        </x-nav-link>
                    </div>

                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        <x-nav-link :href="route('konfigurasi')" :active="request()->routeIs('konfigurasi*')">
                            {{ __('Konfigurasi') }}
                        </x-nav-link>
                    </div>
                @endcan
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @can('admin')
                ...
                <x-responsive-nav-link :href="route('kategori-nilai.index')" :active="request()->routeIs('kategori-nilai*')">
                    {{ __('Kategori Nilai') }}
                </x-responsive-nav-link>

                <x-responsive-nav-link :href="route('konfigurasi')" :active="request()->routeIs('konfigurasi*')">
                    {{ __('Konfigurasi') }}
                </x-responsive-nav-link>
            @endcan
            ...
            <x-responsive-nav-link :href="route('daftar-ulang')" :active="request()->routeIs('daftar-ulang*')">
                {{ __('Daftar Ulang') }}
            </x-responsive-nav-link>
        </div>
