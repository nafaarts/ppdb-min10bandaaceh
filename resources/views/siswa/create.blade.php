            ...
            <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                <form method="post" action="{{ route('siswa.store') }}" enctype="multipart/form-data">
                    ...
                    {{-- <div class="space-y-6">
                        <div class="flex flex-col md:flex-row gap-6">
                            <div class="w-full md:w-1/2">
                                ...
                                <x-text-input id="nama_lengkap" name="nama_lengkap" type="text"
                                    class="mt-1 block w-full" :value="old('nama_lengkap')" autocomplete="nama_lengkap" />
                        ...
                        <div class="flex flex-col md:flex-row gap-6">
                            <div class="w-full md:w-1/2">
                                ...
                                <x-text-input id="tempat_lahir" name="tempat_lahir" type="text"
                                    class="mt-1 block w-full" :value="old('tempat_lahir')" autocomplete="tempat_lahir" />
                            ...
                            <div class="w-full md:w-1/2">
                                ...
                                <x-text-input id="tanggal_lahir" name="tanggal_lahir" type="date"
                                    class="mt-1 block w-full" :value="old('tanggal_lahir')" autocomplete="tanggal_lahir" />
                        ...
                        <div class="flex flex-col md:flex-row gap-6">
                            ...
                            <div class="w-full md:w-1/2">
                                ...
                                <x-text-input id="jumlah_saudara_kandung" name="jumlah_saudara_kandung" type="number"
                                    class="mt-1 block w-full" :value="old('jumlah_saudara_kandung')"
                        ...
                        <div class="flex flex-col md:flex-row gap-6">
                            ...
                            <div class="w-full md:w-1/2">
                                ...
                                <x-text-input id="cita_cita" name="cita_cita" type="text"
                                    class="mt-1 block w-full" :value="old('cita_cita')" autocomplete="cita_cita" />
                        ...
                        <div class="flex flex-col md:flex-row gap-6">
                            ...
                            <div class="w-full md:w-1/2">
                                ...
                                <x-text-input id="transportasi_ke_sekolah" name="transportasi_ke_sekolah"
                                    type="text" class="mt-1 block w-full" :value="old('transportasi_ke_sekolah')"
                        ...
                        <div class="flex flex-col md:flex-row gap-6">
                            <div class="w-full md:w-1/2">
                                ...
                                <x-text-input id="kecamatan" name="kecamatan" type="text"
                                    class="mt-1 block w-full" :value="old('kecamatan')" autocomplete="kecamatan" />
                            ...
                            <div class="w-full md:w-1/2">
                                ...
                                <x-text-input id="kab_kota" name="kab_kota" type="text"
                                    class="mt-1 block w-full" :value="old('kab_kota')" autocomplete="kab_kota" />
                        ...
                        <div class="flex flex-col md:flex-row gap-6">
                            <div class="w-full md:w-1/2">
                                ...
                                <x-text-input id="nama_ayah" name="nama_ayah" type="text"
                                    class="mt-1 block w-full" :value="old('nama_ayah')" autocomplete="nama_ayah" />
                        ...
                        <div class="flex flex-col md:flex-row gap-6">
                            <div class="w-full md:w-1/2">
                                ...
                                <x-text-input id="pekerjaan_ayah" name="pekerjaan_ayah" type="text"
                                    class="mt-1 block w-full" :value="old('pekerjaan_ayah')" autocomplete="pekerjaan_ayah" />
                        ...
                        <div class="flex flex-col md:flex-row gap-6">
                            <div class="w-full md:w-1/2">
                                ...
                                <x-text-input id="no_hp_ayah" name="no_hp_ayah" type="text"
                                    class="mt-1 block w-full" :value="old('no_hp_ayah')" autocomplete="no_hp_ayah" />
                            ...
                            <div class="w-full md:w-1/2">
                                ...
                                <x-text-input id="alamat_ayah" name="alamat_ayah" type="text"
                                    class="mt-1 block w-full" :value="old('alamat_ayah')" autocomplete="alamat_ayah" />
                        ...
                        <div class="flex flex-col md:flex-row gap-6">
                            <div class="w-full md:w-1/2">
                                ...
                                <x-text-input id="nama_ibu" name="nama_ibu" type="text"
                                    class="mt-1 block w-full" :value="old('nama_ibu')" autocomplete="nama_ibu" />
                        ...
                        <div class="flex flex-col md:flex-row gap-6">
                            <div class="w-full md:w-1/2">
                                ...
                                <x-text-input id="pekerjaan_ibu" name="pekerjaan_ibu" type="text"
                                    class="mt-1 block w-full" :value="old('pekerjaan_ibu')" autocomplete="pekerjaan_ibu" />
                        ...
                        <div class="flex flex-col md:flex-row gap-6">
                            <div class="w-full md:w-1/2">
                                ...
                                <x-text-input id="no_hp_ibu" name="no_hp_ibu" type="text"
                                    class="mt-1 block w-full" :value="old('no_hp_ibu')" autocomplete="no_hp_ibu" />
                            ...
                            <div class="w-full md:w-1/2">
                                ...
                                <x-text-input id="alamat_ibu" name="alamat_ibu" type="text"
                                    class="mt-1 block w-full" :value="old('alamat_ibu')" autocomplete="alamat_ibu" />
                        ...
                        <div class="flex flex-col md:flex-row gap-6">
                            <div class="w-full md:w-1/2">
                                ...
                                <x-text-input id="nama_wali" name="nama_wali" type="text"
                                    class="mt-1 block w-full" :value="old('nama_wali')" autocomplete="nama_wali" />
                        ...
                        <div class="flex flex-col md:flex-row gap-6">
                            <div class="w-full md:w-1/2">
                                ...
                                <x-text-input id="pekerjaan_wali" name="pekerjaan_wali" type="text"
                                    class="mt-1 block w-full" :value="old('pekerjaan_wali')" autocomplete="pekerjaan_wali" />
                        ...
                        <div class="flex flex-col md:flex-row gap-6">
                            <div class="w-full md:w-1/2">
                                ...
                                <x-text-input id="no_hp_wali" name="no_hp_wali" type="text"
                                    class="mt-1 block w-full" :value="old('no_hp_wali')" autocomplete="no_hp_wali" />
                            ...
                            <div class="w-full md:w-1/2">
                                ...
                                <x-text-input id="alamat_wali" name="alamat_wali" type="text"
                                    class="mt-1 block w-full" :value="old('alamat_wali')" autocomplete="alamat_wali" />
                        ...
                        <div>
                            <x-input-label for="sertifikat" value="Upload Sertifikat" class="mb-3" />
